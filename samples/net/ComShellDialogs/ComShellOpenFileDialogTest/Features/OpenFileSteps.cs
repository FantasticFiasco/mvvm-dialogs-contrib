...
using ComShellOpenFileDialogTest.ScreenObjects;
...
namespace ComShellOpenFileDialogTest.Features
{
    [Binding]
    public class OpenFileSteps : FeatureSteps<MainScreen>
    {
        ...
        {
            return ScreenRepository.Get<MainScreen>("COM Shell - Open File Dialog", InitializeOption.NoCache);
        }
