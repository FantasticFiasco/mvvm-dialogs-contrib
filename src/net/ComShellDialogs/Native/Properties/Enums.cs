...
namespace MvvmDialogs.ComShellDialogs
{
	...
	/// </summary>
	internal enum PropertyStoreCacheState
	{
		/// <summary>
	...
	/// </remarks>
	[Flags]
	internal enum PropertyDescriptionFormatOptions
	{
		/// <summary>
	...
	/// </summary>
	internal enum PropertyAggregationType
	{
		/// <summary>
	...
	/// </summary>
	[Flags]
	internal enum PropertyColumnStateOptions
	{
		/// <summary>
		/// Default value
		/// </summary>
	...
	/// </summary>
	internal enum PropertyConditionOperation
	{
		/// <summary>
	...
	/// </summary>
	internal enum PropertyGroupingRange
	{
		/// <summary>
	...
	/// </remarks>
	internal enum PropertySortDescription
	{
		/// <summary>
	...
	/// </summary>
	[Flags]
	internal enum PropertyTypeOptions
	{
		/// <summary>
	...
	/// </summary>
	[Flags]
	internal enum PropertyViewOptions
	{
		/// <summary>
